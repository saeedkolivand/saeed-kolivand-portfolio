...
// OUTSIDE — "The One Warm Window": a cold, desaturated cyan noir city that dissolves into the
...
// advances while reduced motion is off, so every animation (smog, rivulets, ripples, flicker)
// freezes together into a calm static postcard for prefers-reduced-motion, with zero vestibular
// trigger (the camera flight itself is scroll-driven, never autonomous). Everything is
// instanced. Camera flies +Z entry -> origin -> -Z exit.

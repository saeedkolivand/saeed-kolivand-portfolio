...
| 2 | crash | 42->40mm | 0.20 | crash-zoom past the hero tower: opens on the roof (AI OPEN 24H sign upper-third, cat + keyboard as rooftop props, neighbor blocks for scale) then dives to the street; FG facade code lines, MG plaza landing ring, BG far dark blocks |
